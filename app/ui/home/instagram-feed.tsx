  ...
  if (INSTAGRAM_SHORTCODES.length === 0) {
    return (
      <a
        ...
        className="flex items-center gap-4 rounded-xl bg-linear-to-r from-purple-500 via-pink-500 to-orange-400 p-6 text-white shadow-xs hover:opacity-90 transition-opacity"
      >
