  ...
  if (INSTAGRAM_SHORTCODES.length === 0) {
    return (
      <a
        ...
        className="flex items-center gap-4 rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 p-6 text-white shadow-sm hover:opacity-90 transition-opacity"
      >
        ...
        <div>
          <p className="font-semibold text-lg">@labandedesidees</p>
